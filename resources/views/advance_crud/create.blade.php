        ...
        <div class="container p-5">
            ...
            <div class="row shadow">
                <div class="col-md-12 d-flex p-4 justify-content-between">
                    <h3>Create Crud</h3>
                    <a href="{{ route('advanceCrud.index') }}" class="btn btn-sm btn-success pt-2"><i class="fa fa-list"></i>
                        List</a>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="applicant">User</label>
                                        <input type="text" class="form-control" name="user" id="applicant"
